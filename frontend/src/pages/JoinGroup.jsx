        ...
        <section className="group-panel mx-auto w-full max-w-3xl rounded-[2rem] border border-[#efe4d0]/35 p-6 md:p-9">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            <label className="block">
              <span className="text-xs uppercase tracking-[0.18em] text-[#eadfcf]/80">Invite code</span>
              <div className="mt-2 flex items-center gap-2 rounded-2xl border border-[#f1e6d6]/35 bg-[#14171d]/55 px-3 py-1">
          ...
          <div className="mt-8">
            <p className="text-xs uppercase tracking-[0.18em] text-[#eadfcf]/80">Public groups</p>
            <div className="mt-3 space-y-2">
              {loadingPublic ? <p className="text-sm text-[#e8dbc7]/80">Loading public groups...</p> : null}
              {!loadingPublic && publicGroups.length === 0 ? (
                <p className="text-sm text-[#e8dbc7]/80">No public groups available right now.</p>
              ) : null}
              {publicGroups.map((publicGroup) => (
                ...
                >
                  <div>
                    ...
                    <p className="text-xs uppercase tracking-[0.16em] text-[#e8dbc7]/70">{publicGroup.join_code}</p>
                  </div>
                  <button
                    type="button"
                  ...
                  <button
                    ...
                    className="rounded-lg border border-[#f3e7d4]/30 bg-[#11151c]/45 px-3 py-1.5 text-xs text-[#efe3d1] transition hover:bg-[#161d27]/60"
                  >
                    Request join
                  </button>
                </div>
